...
{
    public class FIN_PIUTANG_USAHA
    {
    }

    public class FIN_PIUTANG_USAHA_Header
    {
    ...
    public class FIN_PIUTANG_USAHA_Filter
    {
    ...
    public class FIN_PIUTANG_USAHA_Detail
    {
    ...
    public class FIN_PIUTANG_USAHA_Penjualan
    {
        public string no_inv { get; set; }
