...
kendo.ui.Switch.prototype = {
    ...
    check: function(check) {
        ...
        /// </summary>
        /// <param name="check" type="Boolean" >Whether to check or uncheck the Kendo UI Switch.</param>
    ...
    readonly: function(readonly) {
        ...
        /// </summary>
        /// <param name="readonly" type="Boolean" >Whether to make the widget readonly.</param>
