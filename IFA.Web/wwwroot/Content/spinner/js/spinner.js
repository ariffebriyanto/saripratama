...
function startSpinner(text, status) {
    ...
    if (status == 1 && elementExist.length == 0) {
        $('body').append('<div id="coverScreen" class="coverScreen"><div class="spinnerWrapper"><div class="mul8"><div class="mul8circ1"></div><div class="mul8circ2"></div></div><div class="spinnerText"><span class="textContainer">' + text + '</span></div></div></div>');
    }
    else {
