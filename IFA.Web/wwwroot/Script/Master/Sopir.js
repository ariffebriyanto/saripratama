...
$(document).ready(function () {
    ...
    $("#GridBrg").kendoGrid({
        ...
        columns: [
            ...
            { field: "kd_Customer", title: "Kode Sopir", width: "60px", editable: false, hidden: true },
            { field: "nama_Customer", title: "Nama Sopir", width: "150px", editor: Pegawaidropdown  },
            { field: "alamat1", title: "Kode Pegawai", width: "200px", editable: false },
            { field: "no_telepon1", title: "Keterangan", width: "90px" },
            { field: "creditLimit", title: "Credit Limit", width: "90px", hidden: true },
            { field: "saldo_limit", title: "Saldo Limit", width: "90px", editable: false, hidden: true },
            { field: "jatuh_tempo", title: "Umur Piutang", width: "80px", hidden: true }, //
...
function Pegawaidropdown(container, options) {
    $('<input required data-text-field="Nama_Pegawai" data-value-field="Kode_Pegawai" data-bind="value:' + options.field + '"/>')
        .appendTo(container)
        .kendoDropDownList({
            dataTextField: "Nama_Pegawai",
            dataValueField: "Nama_Pegawai",
            dataSource: GudangList,
            change: function (e) {
                var dataItem = e.sender.dataItem();
                options.model.set("alamat1", dataItem.Kode_Pegawai);
            }
        });
}
