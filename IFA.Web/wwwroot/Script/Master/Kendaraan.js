...
$(document).ready(function () {
    dataSource = new kendo.data.DataSource({
        ...
        schema: {
            model: {
                id: "kode_Kendaraan",
                fields: {
                    kode_Kendaraan: { type: "string" },
                    nama_Kendaraan: { validation: { required: true } },
                    kapasitas: { type: "string" },
                    kapasitas_m3: { type: "string" },
                    keterangan: { type: "string" },
                    no_polisi: { type: "string" }
                   // keterangan: { type: "number", validation: { required: true, min: 1, defaultValue: 0 } }
    ...
    $("#GridBrg").kendoGrid({
        ...
        columns: [
            ...
            { field: "kode_Kendaraan", title: "Kode Kendaraan", width: "60px", editable: false},
            { field: "nama_Kendaraan", title: "Nama Kendaraan", width: "150px" },
            
            { field: "kapasitas", title: "Kapasitas", width: "90px" },
            { field: "kapistas_m3", title: "Kapasitas M3", width: "90px" },
            { field: "keterangan", title: "Keterangan", width: "200px" },
            { field: "no_polisi", title: "No Polisi", width: "90px" },
            //{ field: "jatuh_tempo", title: "Jenis Kendaraan", width: "100px" }, //
...
function bindGrid() {
    $("#GridBrg").kendoGrid({
        columns: [
            ...
            { field: "Kode_Kendaraan", title: "Kode Kendaraan", width: "100px" },
            { field: "Nama_Kendaraan", title: "Nama Kendaraan", width: "160px" },
