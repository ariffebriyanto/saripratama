...
function bindGrid() {
    $("#GridOwner").kendoGrid({
        columns: [
            ...
            { field: "Action", width: "200px", template: '<center><a class="btn btn-danger btn-sm hapusData" href="javascript:void(0)" data-id="#=kd_Owner#"><i class="glyphicon glyphicon-trash" aria-hidden="true"></i></a> &nbsp; &nbsp; <a class="btn btn-info btn-sm editData" href="javascript:void(0)" data-id="#=kd_Owner#"><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i></a></center>' },
