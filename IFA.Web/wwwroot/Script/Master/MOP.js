...
function bindGrid() {
    _GridPO = $("#GridPO").kendoGrid({
        columns: [
            ...
            { field: "Nama_Owner", title: "Nama", width: "80px" },
            { field: "Alamat_Owner", title: "Alamat Owner", width: "80px" },
...
function detailInit(e) {
    ...
    startSpinner('loading..', 1);
    $.when(getDetail(e.data.Kd_Owner)).done(function () {
        detailRow.find(".detail").kendoGrid({
                ...
                schema: {
                    model: {
                        ...
                        fields: {
                            ...
                            harga_Pet: { type: "number" }
                            
                           
                        }
                    }
                },
                sort: { field: "kd_Pet", dir: "desc" },
                //  pageSize: 7,
            ...
            columns: [
                ...
                { field: "harga_Pet", title: "harga Pet", width: "250px", format: "{0:#,0.00}", attributes: { class: "text-right " } }
