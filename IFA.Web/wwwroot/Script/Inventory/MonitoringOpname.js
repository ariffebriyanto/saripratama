...
function bindGrid() {
    _GridTerima = $("#GridTerima").kendoGrid({
        columns: [
            ...
            ////{ field: "tgl_jth_tempo", title: "Tanggal Jatuh Tempo", width: "120px", template: "#= kendo.toString(kendo.parseDate(tgl_jth_tempo, 'yyyy-MM-dd'), 'dd MMMM yyyy') #" },
           
            { field: "keterangan", title: "Keterangan", width: "100px" },
            { field: "last_Created_By", title: "User", width: "100px" },           
            { field: "Action", width: "50px", template: "<center style='display:inline;'><a class='btn btn-success btn-sm viewData' href='javascript:void(0)' data-id='#=no_trans#'><i class='glyphicon glyphicon-eye-open' aria-hidden='true'></i></a></center><center style='display:inline;'></center>" }
...
function detailInit(e) {
    ...
    detailRow.find(".detail").kendoGrid({
        ...
        columns: [
            {
                field: "no_seq", title: "No", width: "30px", sortable: {
                    initialDirection: "desc"
                } },
            { field: "nama_barang", title: "Nama Barang", width: "110px" },
            { field: "kd_satuan", title: "Satuan", width: "80px" },
            { field: "qty_data", title: "Qty Data", width: "110px" },
            { field: "qty_opname", title: "Qty Opname", width: "110px" },
            { field: "qty_selisih", title: "Qty Selisih", width: "110px" },
