...
function bindGrid() {
    ...
    _GridTerima = $("#GridTerima").kendoGrid({
        columns: [
            ...
            { field: "nomor", title: "Nomer", width: "100px" },
            { field: "tgl_trans", title: "Tanggal", width: "160px" },
            { field: "kd_valuta", title: "Valuta", width: "40px", hidden: true  },
            { field: "kurs_valuta", title: "Kurs", width: "30px", hidden: true  },
            { field: "total_trans", title: "Total. Trans", width: "120px", format: "{0:n2}", decimals: 2, min: 0},
            { field: "keterangan", title: "Keterangan", width: "120px" },
            { field: "last_Created_By", title: "Dibuat Oleh", width: "120px" },
            ...
            schema: {
                model: {
                    ...
                    fields: {
                        ...
                        kd_valuta: { type: "string"},
                        kurs_valuta: { type: "decimal"},
                        keterangan: { type: "string" },
                        jml_trans: { type: "decimal"},
                        keterangan: { type: "string" }
...
function detailInit(e) {
    ...
    detailRow.find(".detail").kendoGrid({
        ...
        columns: [
            ...
            { field: "jml_trans", title: "Jml. Trans", width: "120px", format: "{0:n2}", decimals: 2, min: 0 },
            { field: "keterangan", title: "Keterangan", width: "120px" },
