...
var ColumnGrid = [
    ...
    { field: "keterangan", title: "Keterangan", attributes: { class: "text-right ", 'style': 'background-color: Beige; color:black;' }, width: "100px" }
            ...
            if (result.length > 0) {
                ...
                if (Mode === "VIEW") {
                    columns = [
                        ...
                        { field: "qty_balik", title: "Qty Kembali", width: "40px", validation: { required: true, min: 1, defaultValue: 0 }, attributes: { class: "text-right " }, "footerTemplate": "Total: #: data.qty_qc_pass ? data.qty_qc_pass.sum: 0 #", footerAttribute: { "id": "qty_qc_pass" }, editor: valueValidation },
                        { field: "qty_out", title: "Qty TerKirim", width: "40px", attributes: { class: "text-right " } },
