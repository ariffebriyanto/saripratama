...
function bindGrid() {
    _GridTerima = $("#GridTerima").kendoGrid({
        columns: [
            { field: "status_sj", title: "STATUS", width: "60px"}, 
            { field: "No_sp", title: "No DO", width: "50px" },
            { field: "no_sj", title: "No SJ", width: "70px" },
            { field: "TglSJ", title: "Tanggal SJ", width: "40px", template: "#= kendo.toString(kendo.parseDate(TglSJ, 'yyyy-MM-dd'), 'dd MMMM yyyy') #" },
            { field: "status_sj", title: "No Renc Kirim", width: "60px", hidden: true }, //Last_created_by
        ...
        success: function (result) {
            ...
            if (jspmWSStatus()) {
                ...
                for (var i = 0; i <= notads[0].detailsvm.length - 1; i++) {
                    ...
                    var spaceTotHrg = 9 - totalhargaString.length;
                    ...
                    var spaceDisc = 9 - (strdisc1.length);
                    ...
                    var spaceRp = 17 - (totalhargaString.length + 1);
                    cmds += " ";
                ...
                cmds += '---------------------------------------------------------------------------------------------------';
                cmds += newLine;
                cmds += "-BCA : 018-2087-58 a/n ACHAZIO KYNAN       -BRI: 0086-0100-0196-562 a/n NATALIA"
                cmds += newLine;
