...
function bindGrid() {
    $("#GridGiro").kendoGrid({
        columns: [
            ...
            { field: "Action", width: "120px", template: "<center style='display:inline;'><a class='btn btn-success btn-sm terimaData' href='javascript:void(0)' data-id='#=nomor#'><i class='glyphicon glyphicon-ok' aria-hidden='true'></i></a>&nbsp<a class='btn btn-default btn-sm tolakData' href='javascript:void(0)' data-id='#=nomor#'><i class='glyphicon glyphicon-remove' aria-hidden='true'></i></a>&nbsp<a class='btn btn-danger btn-sm hapusData' href='javascript:void(0)' data-id='#=nomor#'><i class='glyphicon glyphicon-trash' aria-hidden='true'></i></a></center>" }
        ],
        dataSource: {
            data: listds,
            schema: {
...
function prepareActionGrid() {
    $(".terimaData").on("click", function () {
        var id = $(this).data("id");
        alert('terima: ' + id);
    });
    $(".tolakData").on("click", function () {
        var id = $(this).data("id");
        alert('tolak: ' + id);
